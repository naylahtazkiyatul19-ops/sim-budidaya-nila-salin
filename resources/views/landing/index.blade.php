...
<head>
    ...
    <style>
        * {
        ...
        .illustration-box .fish-icon::after {
            content: '';
            position: absolute;
            top: 50%;
            left: 50%;
        ...
        @media (max-width: 992px) {
            ...
            .illustration-box { max-width: 320px; }
            .illustration-box .fish-icon { font-size: 120px; }
        ...
        @media (max-width: 600px) {
            ...
            .hero-subtitle-small { font-size: 16px; }
            .hero-description { font-size: 16px; }
            .features-grid { grid-template-columns: 1fr; }
            .btn-primary, .btn-outline { padding: 14px 28px; font-size: 16px; width: 100%; justify-content: center; }
