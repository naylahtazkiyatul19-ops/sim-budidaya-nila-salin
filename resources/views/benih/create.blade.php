...
@section('title', 'Tambah Benih - SIM Budidaya Nila Salin')
    ...
    <div class="col-md-8">
        <div class="card">
            <div class="card-header">
                <i class="fas fa-plus text-cyan me-2"></i> Tambah Benih
            </div>
            <div class="card-body">
                <form action="{{ route('benih.store') }}" method="POST">
                    @csrf
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" name="jumlah_benih" class="form-control @error('jumlah_benih') is-invalid @enderror" value="{{ old('jumlah_benih') }}" required>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="date" name="tanggal_tebar" class="form-control @error('tanggal_tebar') is-invalid @enderror" value="{{ old('tanggal_tebar') }}" required>
                        @error('tanggal_tebar') <div class="invalid-feedback">{{ $message }}</div> @enderror
                    </div>

                    <div class="mb-3">
                        <label class="form-label">Sumber Benih</label>
                        <input type="text" name="sumber_benih" class="form-control @error('sumber_benih') is-invalid @enderror" value="{{ old('sumber_benih') }}">
